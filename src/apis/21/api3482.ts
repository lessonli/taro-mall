...
/**
 * 根据专题活动id查询绑定商品
 * http://yapi.bwyd.com/project/21/interface/api/3482
 **/

import request from "@/service/http.ts";

export class IReqapi3482 {
  /**
   * 活动id
   */
...
export const req3482Config = (data: IReqapi3482) => ({
 ...
 * 根据专题活动id查询绑定商品
 **/
export default function (data: IReqapi3482 = {}): Promise<IResapi3482["data"]> {
  return request(req3482Config(...arguments));
}
