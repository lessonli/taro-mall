...
/**
 * 查询红包列表
 * http://yapi.bwyd.com/project/21/interface/api/4660
 **/

import request from "@/service/http.ts";

export class IReqapi4660 {
  /**
   * 商户ID
   */
  merchantId?: string | number;
  /**
   * 红包类型：1-分享红包2-直播间红包,,@seecom.bwyd.distribution.enums.RedPacketType
   */
  type?: string | number;
...
/**
 * Result<PaginatedData<RedPacketVo>> :Result
 */
export class IResapi4660 {
  code?: number;
  message?: string;
  traceId?: string;
  /**
...
export const req4660Config = (data: IReqapi4660) => ({
  url: `/red/packet/merchant/list`,
  method: "GET",
  header: {
 ...
 * 查询红包列表
 **/
export default function (data: IReqapi4660 = {}): Promise<IResapi4660["data"]> {
  return request(req4660Config(...arguments));
}
