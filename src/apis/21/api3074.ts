...
export class IReqapi3074 {}

/**
 * Result<OrderDetailVO> :Result
 */
export class IResapi3074 {
  code?: number;
  message?: string;
  traceId?: string;
  /**
...
export const req3074Config = (orderNo, data: IReqapi3074) => ({
  url: `/merchant/order/detail/${orderNo}`,
  method: "GET",
  header: {
...
export default function (
  orderNo,
  data: IReqapi3074 = {}
): Promise<IResapi3074["data"]> {
  return request(req3074Config(...arguments));
}
