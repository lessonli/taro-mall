...
export const req2188Config = (data: IReqapi2188) => ({
  url: `/order/h5/rePay`,
  method: "POST",
  header: {
...
export default function (data: IReqapi2188 = {}): Promise<IResapi2188["data"]> {
  return request(req2188Config(...arguments));
}
