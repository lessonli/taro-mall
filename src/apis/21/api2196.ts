...
export const req2196Config = (data: IReqapi2196) => ({
  url: `/order/app/rePay`,
  method: "POST",
  header: {
...
export default function (data: IReqapi2196 = {}): Promise<IResapi2196["data"]> {
  return request(req2196Config(...arguments));
}
