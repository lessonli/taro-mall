...
/**
 * 查询红包领取信息
 * http://yapi.bwyd.com/project/21/interface/api/4680
 **/

import request from "@/service/http.ts";

export class IReqapi4680 {
  /**
   * (String)
   */
...
export const req4680Config = (data: IReqapi4680) => ({
  url: `/red/packet/user/getByRedPacketId`,
  method: "GET",
  header: {
 ...
 * 查询红包领取信息
 **/
export default function (data: IReqapi4680 = {}): Promise<IResapi4680["data"]> {
  return request(req4680Config(...arguments));
}
