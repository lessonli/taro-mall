 ...
 * http://yapi.bwyd.com/project/21/interface/api/3800
 **/

import request from "@/service/http.ts";

export class IReqapi3800 {
...
export const req3800Config = (data: IReqapi3800) => ({
 ...
 * 商家培养的团队列表，不分页，可排序（排序可选值：privateFansCount 专属粉丝，directSubMerchantCount 邀请商家）
 **/
export default function (data: IReqapi3800 = {}): Promise<IResapi3800["data"]> {
  return request(req3800Config(...arguments));
}
