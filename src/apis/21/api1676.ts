...
/**
 * 根据订单号获取订单详情
 * http://yapi.bwyd.com/project/21/interface/api/1676
 **/

import request from "@/service/http.ts";

export class IReqapi1676 {
  /**
   * 订单号(String)
   */
...
/**
 * Result<OrderUserPageDetailVo> :Result
 */
export class IResapi1676 {
  code?: number;
  message?: string;
  traceId?: string;
  /**
   * OrderUserPageDetailVo
   */
  data?: {
    /**
     * 订单商品 ,OrderItemVo
...
export const req1676Config = (data: IReqapi1676) => ({
  url: `/order/get`,
  method: "GET",
  header: {
 ...
 * 根据订单号获取订单详情
 **/
export default function (data: IReqapi1676 = {}): Promise<IResapi1676["data"]> {
  return request(req1676Config(...arguments));
}
