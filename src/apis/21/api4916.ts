...
/**
 * 分页查询店铺优惠券信息(优惠券管理)
 * http://yapi.bwyd.com/project/21/interface/api/4916
 **/

import request from "@/service/http.ts";

export class IReqapi4916 {
  /**
...
export const req4916Config = (data: IReqapi4916) => ({
 ...
 * 分页查询店铺优惠券信息(优惠券管理)
 **/
export default function (data: IReqapi4916 = {}): Promise<IResapi4916["data"]> {
  return request(req4916Config(...arguments));
}
