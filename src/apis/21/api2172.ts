...
export const req2172Config = (data: IReqapi2172) => ({
  url: `/order/pc/create`,
  method: "POST",
  header: {
...
export default function (data: IReqapi2172 = {}): Promise<IResapi2172["data"]> {
  return request(req2172Config(...arguments));
}
