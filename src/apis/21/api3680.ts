...
/**
 * 根据订单获取操作记录
 * http://yapi.bwyd.com/project/21/interface/api/3680
 **/

import request from "@/service/http.ts";

export class IReqapi3680 {
  /**
   * 订单号(String)
   */
...
export const req3680Config = (data: IReqapi3680) => ({
  url: `/order/listOperateRecord`,
  method: "GET",
  header: {
 ...
 * 根据订单获取操作记录
 **/
export default function (data: IReqapi3680 = {}): Promise<IResapi3680["data"]> {
  return request(req3680Config(...arguments));
}
