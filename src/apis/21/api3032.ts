...
export const req3032Config = (data: IReqapi3032) => ({
  url: `/auction/merchant/margin`,
  method: "POST",
  header: {
...
export default function (data: IReqapi3032 = {}): Promise<IResapi3032["data"]> {
  return request(req3032Config(...arguments));
}
