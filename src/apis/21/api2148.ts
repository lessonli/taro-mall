...
export const req2148Config = (data: IReqapi2148) => ({
  url: `/order/h5/create`,
  method: "POST",
  header: {
...
export default function (data: IReqapi2148 = {}): Promise<IResapi2148["data"]> {
  return request(req2148Config(...arguments));
}
