...
export const req2204Config = (data: IReqapi2204) => ({
  url: `/order/mp/rePay`,
  method: "POST",
  header: {
...
export default function (data: IReqapi2204 = {}): Promise<IResapi2204["data"]> {
  return request(req2204Config(...arguments));
}
