...
/**
 * 获取分享链接
 * http://yapi.bwyd.com/project/21/interface/api/3554
 **/

import request from "@/service/http.ts";

export class IReqapi3554 {
  /**
...
export const req3554Config = (data: IReqapi3554) => ({
  url: `/share/link`,
  method: "GET",
  header: {
 ...
 * 获取分享链接
 **/
export default function (data: IReqapi3554 = {}): Promise<IResapi3554["data"]> {
  return request(req3554Config(...arguments));
}
